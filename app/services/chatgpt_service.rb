  ...
  def call
    body = {
      ...
      messages: [
        {
          role: 'system',
          content: 'You are now using the ChatGPT API to translate the provided' \
                   'HTML content into English while preserving its structure.'
        },
        {
          role: 'user',
          content: message
        ...
        {
          role: 'assistant',
          content: 'Translate the provided HTML content into English while preserving its structure.'
        }
      ]
    }
